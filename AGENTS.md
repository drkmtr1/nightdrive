...
Nightdrive helps producers create original, editable musical material. Stage 1, Stage 2A, Stage 3A, Stage 3B1, Stage 3B2a, Stage 3B2b1, Stage 3B2b2a, Stage 3B2b2b, Stage 3B2b2c, Stage 3B2b2d, Stage 3B2b2e, Stage 3B2b2f, and Stage 3B2b2g are merged; Stage 3B2c1 is an accepted merged contract-definition milestone, while PRNG implementation remains separately gated. Later capability gates still require separately authorized bounded tasks. Do not provision Supabase, deploy to Vercel, install models, or implement note spelling, named intervals, extensions, harmony, MIDI export, generation, audio, persistence, or AI features before their roadmap stages are explicitly authorized.
