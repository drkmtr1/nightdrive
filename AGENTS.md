...
- A qualified, separate Codex reviewer may satisfy required independent exact-head review only within the [routine reviewer substitution gate](docs/AI_ENGINEERING_WORKFLOW.md#routine-dedicated-reviewer-substitution). Consequential contracts, architecture, canonical/evidence or qualification boundaries, milestone closure, releases, and review-governance changes retain the existing independent reviewer. The candidate author cannot approve its own work; reviewer substitution never relaxes CI, publication, or merge policy.
