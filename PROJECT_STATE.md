...
The next eligible gate is **SPECIFY — matched V1/R1 comparison design under the existing evaluation contracts, using unchanged R1**. This does not authorize listening execution, MIDI/audio artifact generation unless separately authorized by the comparison-design outcome, new weights, a new dataset/version, policy-semantic changes, aggregate provenance, or Stage 8. The baseline remains exploratory, R1-REV-001 remains partially closed, and MIA-003 remains deferred/non-blocking.
