...
Prepare the separately authorized full pinned-Node AC-004 evidence for the accepted Stage 7 aggregate implementation under the [Stage 7 aggregate/provenance specification](docs/COMPOSITION_ENGINE.md#stage-7-aggregate-generation-contract). Do not claim cross-runtime equivalence or Stage 7 completion until the required evidence and exit reconciliation pass. Stage 7 remains open and Stage 8 unauthorized. AC-011/AC-013 remain satisfied, R1-REV-001 remains partially closed, and MIA-003 remains deferred/non-blocking.
