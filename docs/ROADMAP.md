...
**Current review gate:** The enclosing integration/error-precedence operation and its exact automated regression evidence are implemented on the current review branch. Acceptance/merge, aggregate provenance, and structured human evaluation remain separately gated.
