...
**Pre-implementation gates:** Accept the Stage 7C3 `nightdrive.seed-derivation.component.v1` contract currently under review; freeze exact profile candidates, weights, and gate candidates; and freeze structured error taxonomy/precedence. Any further Stage 7C contract slice requires separate authorization.
