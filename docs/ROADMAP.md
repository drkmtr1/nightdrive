...
**Exit:** Full Stage 7 remains open until aggregate contract/runtime and AC-004 evidence are accepted and exit evidence is reconciled. Preserve satisfied AC-011/AC-013; PR #142 satisfies the current R1 human product-acceptance gate by exception, without further listening or a claim that the 280-fixture protocol completed.
