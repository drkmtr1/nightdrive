...
The accepted contract excludes inversion, retrograde, augmentation, diminution, chromatic transformation, arbitrary LLM notes, hidden random draws, and silent policy tuning. Bounded implementation under that settled authority does not change the accepted First Playable boundary.
