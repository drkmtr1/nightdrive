...
**Date:** 2026-09-17
**Status:** Accepted
**Checkpoint:** Successor compatibility documentation accepted and merged through PR #109 (merge commit `590075f45a4d5e03480b1d8c3a076d1119cb03e9`); the exact R1 calibration candidate is documented for separate review.
...
**Date:** 2026-09-17
**Status:** Accepted for the two product-owner decisions below; the complete V2 public contract remains a separate review-pending documentation proposal.
...
**Consequences:** Later V2 tests must prove extra-property invariance, missing-field failures, the four V1/V2 version combinations and exact first failures, and V1 replay isolation. The proposed full request/result/error contract is owned by the [Arpeggiator model](ARPEGGIATOR_MODEL.md) and awaits ChatGPT review. This ADR does not accept that complete draft, authorize runtime implementation, or change ADR-019 or the V1 operation.
