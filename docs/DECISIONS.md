...
**Date:** 2026-09-10
**Status:** Accepted for the Stage 5A boundary and dependency-spike definition; Stage 5B1 IR and Stage 5B2a isolated serializer-adapter implementations are merged, Stage 5B2b independent parser/reference evidence is separately bounded, and production parser/round-trip and delivery remain separately gated.
