...
Stage 7C7a7 implements only profile-list selection, supplied component-seed PRNG consumption, canonical gate mapping, and the frozen resolved plan. Mask execution, octave expansion, event projection, profile/Harmony compatibility, enclosing integration, and public error translation remain separately gated.
