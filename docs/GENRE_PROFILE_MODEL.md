...
Profile selection, component-seed/PRNG consumption, the resolver, gate mapping after selection, resolved plans, mask execution, octave expansion, event projection, profile/Harmony compatibility, enclosing integration, and public error translation remain separately gated; Stage 7C7a7 policy resolution is the next bounded slice under separate authorization.
