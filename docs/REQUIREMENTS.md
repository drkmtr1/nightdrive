...
| MUS-012 | P0 | The V1 `ChordQuality` contract is a closed triad-only vocabulary with stable IDs and exact tonic-relative chromatic membership formulas; quality excludes root, ordering, inversions, voicings, spelling, and extensions, and seventh structures remain deferred extension metadata. | AC-039 | 3B2b2b |
